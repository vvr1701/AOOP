    ...
    public void run() {
        while (true) {
            synchronized (SharedResource.lock) {
                ...
                if (SharedResource.number % 5 == 0 && SharedResource.number % 2 != 0 && SharedResource.number % 3 != 0 && SharedResource.number % 4 != 0) {
                    System.out.println("Divisible by 5: " + SharedResource.number);
